...
int main(int argc, char *argv[]) {
  ...
  omp_lock_t *locks = (omp_lock_t *)malloc(NUM_TETRANUCS * sizeof(omp_lock_t));
...
#pragma omp parallel for default(none) private(gene_index, t)                  \
    shared(TF, genes, locks)
...
#pragma omp parallel for default(none)                                         \
    shared(TF, genes, average_TF, locks) private(t)
